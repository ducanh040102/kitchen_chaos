...
public class OptionUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            RebindBinding(GameInput.Binding.Gamepad_AlternateInteract);
        });
    ...
    private void UpdateVisual()
    {
        ...
        gamepadInteractAlternateText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Gamepad_AlternateInteract);
